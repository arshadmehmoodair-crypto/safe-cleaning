...
const products = [
  {
    ...
    image: floorCleaner,
    price: "£12.99",
    description: "Professional floor cleaner suitable for homes and commercial buildings.",
    features: [
      "Fast Drying",
      "Fresh Fragrance",
      "Safe on Most Floors",
  ...
  },
{
  ...
  image: glassCleaner,
  price: "£8.99",
  description: "Professional glass cleaner for windows, mirrors and glass surfaces.",
  features: [
    "Streak Free",
    "Quick Dry",
